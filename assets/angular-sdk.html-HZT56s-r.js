import{_ as n,c as s,d as a,o as i}from"./app-DqylX75P.js";const t={};function l(d,e){return i(),s("div",null,e[0]||(e[0]=[a(`<h1 id="angular-sdk" tabindex="-1"><a class="header-anchor" href="#angular-sdk"><span>Angular SDK</span></a></h1><h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装"><span>安装</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">npm install @melody-auth/angular --save</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><h2 id="authprovider" tabindex="-1"><a class="header-anchor" href="#authprovider"><span>AuthProvider</span></a></h2><p>在应用启动时向引导模块提供认证相关配置。</p><table><thead><tr><th>参数</th><th>类型</th><th>描述</th><th>默认值</th><th>必填</th></tr></thead><tbody><tr><td>clientId</td><td>string</td><td>前端连接的 app <strong>clientId</strong></td><td>N/A</td><td>是</td></tr><tr><td>redirectUri</td><td>string</td><td>认证成功后重定向的 URL</td><td>N/A</td><td>是</td></tr><tr><td>serverUri</td><td>string</td><td>托管认证服务器的 URL</td><td>N/A</td><td>是</td></tr><tr><td>scopes</td><td>string[]</td><td>需要申请的权限作用域</td><td>N/A</td><td>否</td></tr><tr><td>storage</td><td>&#39;sessionStorage&#39; | &#39;localStorage&#39;</td><td>用于存储认证令牌的存储类型</td><td>&#39;localStorage&#39;</td><td>否</td></tr><tr><td>onLoginSuccess</td><td>(attr: { locale?: string; state?: string }) =&gt; void</td><td>登录成功后的回调函数</td><td>N/A</td><td>否</td></tr></tbody></table><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">import { bootstrapApplication } from &#39;@angular/platform-browser&#39;</span>
...
<span class="line">  }</span>
<span class="line">}</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="logoutredirect" tabindex="-1"><a class="header-anchor" href="#logoutredirect"><span>logoutRedirect</span></a></h2><p>触发退出登录流程。</p><table><thead><tr><th>参数</th><th>类型</th><th>描述</th><th>默认值</th><th>必填</th></tr></thead><tbody><tr><td>postLogoutRedirectUri</td><td>string</td><td>退出后跳转的 URL</td><td>N/A</td><td>否</td></tr></tbody></table><blockquote><p><strong>注意：</strong> <code>postLogoutRedirectUri</code> 必须与应用已注册的 redirect URI 之一匹配（在管理面板中配置）。如果不匹配，用户仍会退出登录，但浏览器将被重定向到应用的第一个已注册 redirect URI 作为安全回退。</p></blockquote><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">import { CommonModule } from &#39;@angular/common&#39;</span>
<span class="line">import { Component } from &#39;@angular/core&#39;</span>
<span class="line">import { AuthService } from &#39;@melody-auth/angular&#39;</span>
<span class="line"></span>
<span class="line">@Component({</span>
