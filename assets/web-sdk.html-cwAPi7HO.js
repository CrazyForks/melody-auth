import{_ as s,c as n,a,o as t}from"./app-CM6IoGSx.js";const d={};function i(l,e){return t(),n("div",null,e[0]||(e[0]=[a(`<h1 id="web-sdk" tabindex="-1"><a class="header-anchor" href="#web-sdk"><span>Web SDK</span></a></h1><p>Web SDK 可让你将 Melody Auth 集成到使用原生 JavaScript 的 Web 应用程序中。</p><h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装"><span>安装</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">npm install @melody-auth/web --save</span>
